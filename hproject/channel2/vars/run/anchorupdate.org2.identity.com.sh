...
export CORE_PEER_ADDRESS=peer2.org2.identity.com:7051
export CORE_PEER_TLS_ROOTCERT_FILE=/vars/keyfiles/peerOrganizations/org2.identity.com/peers/peer2.org2.identity.com/tls/ca.crt
...
jq '.channel_group.groups.Application.groups."org2-identity-com".values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "peer2.org2.identity.com","port": 7051}]},"version": "0"}}' mychannel_current_config.json > mychannel_modified_anchor_config.json
