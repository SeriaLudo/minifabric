...
export ORDERER_ADDRESS=orderer2.identity.com:7050
export ORDERER_TLS_CA=/vars/keyfiles/ordererOrganizations/identity.com/orderers/orderer2.identity.com/tls/ca.crt
...
jq '.channel_group.groups.Application.groups."org1-identity-com".values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "peer2.org1.identity.com","port": 7051}]},"version": "0"}}' mychannel_current_config.json > mychannel_modified_anchor_config.json
