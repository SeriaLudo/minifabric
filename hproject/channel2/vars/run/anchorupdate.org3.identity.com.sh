...
jq '.channel_group.groups.Application.groups."org3-identity-com".values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "peer1.org3.identity.com","port": 7051}]},"version": "0"}}' mychannel_current_config.json > mychannel_modified_anchor_config.json
