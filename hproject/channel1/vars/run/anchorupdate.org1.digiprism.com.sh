...
jq '.channel_group.groups.Application.groups."org1-digiprism-com".values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "192.168.86.33","port": 7004}]},"version": "0"}}' mychannel_current_config.json > mychannel_modified_anchor_config.json
